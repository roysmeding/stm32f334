...
impl W {
    ...
    #[doc = "Bit 30 - Timer E Compare 4"]
    #[inline]
    pub fn timecmp4(&mut self) -> _TIMECMP4W {
        _TIMECMP4W { w: self }
    }
    #[doc = "Bit 29 - Timer E Compare 2"]
    #[inline]
    pub fn timecmp2(&mut self) -> _TIMECMP2W {
        _TIMECMP2W { w: self }
    }
    #[doc = "Bit 28 - Timer E Compare 1"]
    #[inline]
    pub fn timecmp1(&mut self) -> _TIMECMP1W {
        _TIMECMP1W { w: self }
    }
    #[doc = "Bit 27 - Timer D Compare 4"]
    #[inline]
