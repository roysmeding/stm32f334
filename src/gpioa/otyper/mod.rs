...
impl OT15R {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            OT15R::PUSH_PULL => false,
            OT15R::OPEN_DRAIN => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl OT15W {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            OT15W::PUSH_PULL => false,
            OT15W::OPEN_DRAIN => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _OT15W<'a> {
    ...
    pub fn push_pull(self) -> &'a mut W {
        self.variant(OT15W::PUSH_PULL)
    }
    #[doc = "Output open-drain"]
    #[inline]
    pub fn open_drain(self) -> &'a mut W {
        self.variant(OT15W::OPEN_DRAIN)
    }
