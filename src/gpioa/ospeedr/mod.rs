...
impl OSPEEDR15R {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            OSPEEDR15R::LOW_SPEED => 0,
            OSPEEDR15R::MEDIUM_SPEED => 1,
            OSPEEDR15R::HIGH_SPEED => 3,
    ...
    pub fn _from(value: u8) -> OSPEEDR15R {
        match value {
            0 => OSPEEDR15R::LOW_SPEED,
            1 => OSPEEDR15R::MEDIUM_SPEED,
            3 => OSPEEDR15R::HIGH_SPEED,
    ...
    pub fn is_low_speed(&self) -> bool {
        *self == OSPEEDR15R::LOW_SPEED
    }
    #[doc = "Checks if the value of the field is `MEDIUM_SPEED`"]
    #[inline]
    pub fn is_medium_speed(&self) -> bool {
        *self == OSPEEDR15R::MEDIUM_SPEED
    }
    #[doc = "Checks if the value of the field is `HIGH_SPEED`"]
    #[inline]
    pub fn is_high_speed(&self) -> bool {
        *self == OSPEEDR15R::HIGH_SPEED
    }
}
...
impl OSPEEDR15W {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            OSPEEDR15W::LOW_SPEED => 0,
            OSPEEDR15W::MEDIUM_SPEED => 1,
            OSPEEDR15W::HIGH_SPEED => 3,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _OSPEEDR15W<'a> {
    ...
    pub fn low_speed(self) -> &'a mut W {
        self.variant(OSPEEDR15W::LOW_SPEED)
    }
    #[doc = "Medium speed"]
    #[inline]
    pub fn medium_speed(self) -> &'a mut W {
        self.variant(OSPEEDR15W::MEDIUM_SPEED)
    }
    #[doc = "High speed"]
    #[inline]
    pub fn high_speed(self) -> &'a mut W {
        self.variant(OSPEEDR15W::HIGH_SPEED)
    }
...
impl R {
    ...
    #[doc = "Bits 14:15 - Pin 8 output speed"]
    #[inline]
