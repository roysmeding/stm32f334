...
impl W {
    ...
    #[doc = "Bits 7:10 - STRTPW"]
    #[inline]
    pub fn strtpw(&mut self) -> _STRTPWW {
        _STRTPWW { w: self }
    }
    #[doc = "Bits 4:6 - Timerx chopper duty cycle value"]
    #[inline]
    pub fn chpdty(&mut self) -> _CHPDTYW {
        _CHPDTYW { w: self }
    }
    #[doc = "Bits 0:3 - Timerx carrier frequency value"]
    #[inline]
    pub fn chpfrq(&mut self) -> _CHPFRQW {
        _CHPFRQW { w: self }
    }
}
